...
runtime is influenced by CPU frequency. A program that is more CPU-bound will have a smaller score than a program that
is memory-bound or IO-bound. Each sample program is run multiple times, and the average of the runs is used
